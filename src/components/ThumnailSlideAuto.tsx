...
const thumnailImgList = [
    ...
    <img key="5" src="/trash-disposal-img/danger.jpg" alt="danger-disposal" className='rounded-t-lg w-[350px] h-[192px] justify-between items-center md:pl-2 md:pr-2' />,
...
export default function ThumbnailSlideAuto() {
    ...
    return (
        <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchedEnd}>
            {!isMobile && isSliding ? (
                // For PC
                <div className="relative m-auto w-full h-48 overflow-hidden bg-white before:absolute before:left-0 before:top-0 before:z-[2] before:h-full before:w-[100px] before:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] before:content-[''] after:absolute after:right-0 after:top-0 after:z-[2] after:h-full after:w-[100px] after:-scale-x-100 after:bg-[linear-gradient(to_right,white_0%,rgba(255,255,255,0)_100%)] after:content-['']">
