...
export default function ThumbnailVideoSlide_Swiper() {
    ...
    const onAutoplayTimeLeft = (s: any, time: number, progress: number) => {
        if (progressCircle.current) {
            ...
            console.log(progressCircle.current.style.setProperty('--progress', String(1 - progress)))
        }
    ...
    return (
        <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchedEnd}>
            ...
            >
                <SwiperSlide className='rounded-t-lg w-[320px] h-[192px] justify-between items-center md:pl-2 md:pr-2'>
